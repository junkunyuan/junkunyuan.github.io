...
<a href="https://docs.pytorch.org/docs/stable/nn.functional.html">operations</a>, 
<a href="https://docs.pytorch.org/docs/stable/generated/torch.arange.html">arange</a>, 
<a href="https://docs.pytorch.org/docs/stable/generated/torch.rand.html">random</a>, 
<a href="https://docs.pytorch.org/docs/stable/generated/torch.Tensor.size.html">size</a>, 
<a href="https://docs.pytorch.org/docs/stable/generated/torch.reshape.html">reshape</a>, 
<a href="https://docs.pytorch.org/docs/stable/generated/torch.flatten.html">flatten</a>, 
<a href="https://docs.pytorch.org/docs/stable/generated/torch.transpose.html">tranpose</a>,
<a href="https://docs.pytorch.org/docs/stable/generated/torch.permute.html#torch.permute">permute</a>,
...
<a href="https://docs.pytorch.org/docs/stable/generated/torch.where.html">where</a>.""",
"details": 
"""
<pre>
<code class="language-python">
...
## Permute
## --------------------------------------------------------------------------------
dims = /  # *** tuple of int. The desired ordering of dims
y = x.permute(dims)
## --------------------------------------------------------------------------------
