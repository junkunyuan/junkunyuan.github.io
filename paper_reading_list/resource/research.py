...
"""
<ul>
    <li> <b>Code.</b> Choose a suitable codebase from open-sourced projects related to your topic. It should be flexible, reliable, and easy to use.
...
<ul>
    ...
    <li> <b>Introduction.</b> It should cover: (1) Background of the topic. (2) Motivation of the research. (3) Motivation of your idea and method. (4) High-level overview of your method with key components. (5) Experiments with major results and findings. (6) The value of the work to this field. (7) A brief summary of contributions (optional). <b>Note:</b> avoid excessive background or method details—focus on the core contributions.
    <li> <b>Related Works.</b> Provide context by addressing: (1) What previous works have done? (2) What they have overlooked or left unresolved? <b>Note:</b> avoid listing works haphazardly; instead, thoughtfully select represatative works and present them in a ligical, well-organized manner.
    ...
    <li> <b>Conclusion.</b> Summarize the achievement, limitations, and broader implications of the work. Highlight future directions that others can build on. <b>Note:</b> keep this forward-looking, while Abstract focuses on current contributions.
</ul>
...
{
"title": "Open Source",
"venue": "Make the project open-sourced.",
"name": "open source",
"category": "A Guide to the Research Process",
"details": 
"""
