...
<p>
    During Sep 2023 — Nov 2025, I interned and then worked as a Research Scientist in the Multimodal Generation Foundation Model Team at <b>Tencent Hunyuan (Shenzhen, China)</b>, where my research focused on multimodal generative foundation models and their various downstream applications, working with <a href="https://scholar.google.com/citations?user=AjxoEpIAAAAJ">Wei Liu</a>, <a href="https://scholar.google.com.hk/citations?user=igtXP_kAAAAJ&hl=zh-CN&oi=ao">Zhao Zhong</a>, and <a href="https://scholar.google.com.hk/citations?user=FJwtMf0AAAAJ&hl=zh-CN&oi=ao">Liefeng Bo</a>.
    
    During Jul 2022 — Aug 2023, I was a research intern in the Computer Vision Group at <b>Baidu VIS (Beijing, China)</b>, where my research focused on visual self-supervised pre-training, working with <a href="https://scholar.google.com/citations?user=PSzJxD8AAAAJ">Xinyu Zhang</a> and <a href="https://scholar.google.com/citations?user=z5SPCmgAAAAJ">Jingdong Wang</a>.<br><br>
